...
struct AppearanceView: View {
    ...
    var body: some View {
        NavigationStack {
            ScrollView {
                VStack(spacing: 24) {
                    // Three option cards - frosted glass
                    HStack(spacing: 12) {
                            ...
                            Button {
                                ...
                                VStack(spacing: 8) {
                                    Image(systemName: option.icon)
                                        ...
                                        .foregroundStyle(selectedAppearance == option ? LuminaColor.accentBlue : .primary)
                                ...
                                .overlay(
                                    RoundedRectangle(cornerRadius: 16)
                                        .stroke(
                                            selectedAppearance == option
                                            ? LuminaColor.accentBlue.opacity(0.6)
                                            : Color.white.opacity(0.25),
                                            lineWidth: selectedAppearance == option ? 1.5 : 0.8
                                        )
                                )
